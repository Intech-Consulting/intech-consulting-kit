...
extension NSObjectProtocol where Self: NSObject {
    public func combine<Arg1, Arg2>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>, _ sourceKeyPathArg2: KeyPath<Self, Arg2>, completion: @escaping (Arg1, Arg2) -> Swift.Void) -> Disposable {
    ...
    public func combine<Arg1, Arg2, Arg3>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>, _ sourceKeyPathArg2: KeyPath<Self, Arg2>, _ sourceKeyPathArg3: KeyPath<Self, Arg3>, completion: @escaping (Arg1, Arg2, Arg3) -> Swift.Void) -> Disposable {
    ...
    public func combine<Arg1, Arg2, Arg3, Arg4>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>, _ sourceKeyPathArg2: KeyPath<Self, Arg2>, _ sourceKeyPathArg3: KeyPath<Self, Arg3>, _ sourceKeyPathArg4: KeyPath<Self, Arg4>, completion: @escaping (Arg1, Arg2, Arg3, Arg4) -> Swift.Void) -> Disposable {
    ...
    public func combine<Arg1, Arg2, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>, _ sourceKeyPathArg2: KeyPath<Self, Arg2>, result resultKeyPath: ReferenceWritableKeyPath<Self, Value>, completion: @escaping (Arg1, Arg2) -> Value) -> Disposable {
    ...
    public func combine<Arg1, Arg2, Arg3, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>, _ sourceKeyPathArg2: KeyPath<Self, Arg2>, _ sourceKeyPathArg3: KeyPath<Self, Arg3>, result sourceKeyPathValue: ReferenceWritableKeyPath<Self, Value>, completion: @escaping (Arg1, Arg2, Arg3) -> Value) -> Disposable {
    ...
    public func combine<Arg1, Arg2, Arg3, Arg4, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>,
    ...
    public func combine<Arg1, Arg2, Target: AnyObject, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>,
                                                              _ sourceKeyPathArg2: KeyPath<Self, Arg2>,
                                                              cible: Target,
    ...
    // swiftlint:disable function_parameter_count
    public func combine<Arg1, Arg2, Arg3, Target: AnyObject, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>,
                                                                    _ sourceKeyPathArg2: KeyPath<Self, Arg2>,
                                                                    _ sourceKeyPathArg3: KeyPath<Self, Arg3>,
                                                                    cible: Target,
                                                                    cibleKeyPath: ReferenceWritableKeyPath<Target, Value>,
    ...
    // swiftlint:disable function_parameter_count
    public func combine<Arg1, Arg2, Arg3, Arg4, Target: AnyObject, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>,
                                                                          _ sourceKeyPathArg2: KeyPath<Self, Arg2>,
                                                                          _ sourceKeyPathArg3: KeyPath<Self, Arg3>,
                                                                          _ sourceKeyPathArg4: KeyPath<Self, Arg4>,
                                                                          cible: Target,
    ...
    // swiftlint:disable function_parameter_count
    public func combine<Arg1, Arg2, Arg3, Arg4, Arg5, Target: AnyObject, Value>(_ sourceKeyPathArg1: KeyPath<Self, Arg1>,
                                                                                _ sourceKeyPathArg2: KeyPath<Self, Arg2>,
                                                                                _ sourceKeyPathArg3: KeyPath<Self, Arg3>,
                                                                                _ sourceKeyPathArg4: KeyPath<Self, Arg4>,
