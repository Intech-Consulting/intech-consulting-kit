...
public extension CombineExtensions where Base: UIPinchGestureRecognizer {
...
public extension CombineExtensions where Base: UIRotationGestureRecognizer {
...
public extension CombineExtensions where Base: UISwipeGestureRecognizer {
...
public extension CombineExtensions where Base: UIPanGestureRecognizer {
...
public extension CombineExtensions where Base: UIScreenEdgePanGestureRecognizer {
...
public extension CombineExtensions where Base: UILongPressGestureRecognizer {
